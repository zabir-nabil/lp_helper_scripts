...
image_path = ["../lp_videos/26.mp4", "../lp_videos/out.mp4", "../lp_videos/2.mp4", "../lp_videos/vid3.avi"] # video paths
...
save_folder_tag = ["../dump/vid1", "../dump/vid2", "../dump/vid3", "../dump/vid4"]

video = 1 # video or folder
...
for i, i_path in enumerate(image_path):
    ...
    if not video:
        ...
        vid_cap = cv2.VideoCapture(i_path)
    ...
    if not video:
        ...
        for i_f in tqdm(range(int(vid_cap.get(cv2.CAP_PROP_FRAME_COUNT)))):
            try:  
                ret, ori_frame = vid_cap.read() 
